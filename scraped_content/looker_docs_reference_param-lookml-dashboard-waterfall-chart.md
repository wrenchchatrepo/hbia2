# https://cloud.google.com/looker/docs/reference/param-lookml-dashboard-waterfall-chart

Depth: 3

This page demonstrates how to add and customize a LookML dashboard element of `type: looker_waterfall` with LookML dashboard parameters in a [`dashboard.lkml` file](/looker/docs/other-project-files#dashboard_files).

For information about building a waterfall chart through the Looker UI, see the [Waterfall chart options](/looker/docs/waterfall-options) documentation page.
...
`height` (for elements) | Defines the height of the element in units of [`tile_size`](/looker/docs/reference/param-lookml-dashboard#tile_size) for [`layout: tile`](/looker/docs/reference/param-lookml-dashboard#layout) and [`layout: static`](/looker/docs/reference/param-lookml-dashboard#layout) dashboards  
`width` (for elements) | Defines the width of the element in units of [`tile_size`](/looker/docs/reference/param-lookml-dashboard#tile_size) for [`layout: tile`](/looker/docs/reference/param-lookml-dashboard#layout) and [`layout: static`](/looker/docs/reference/param-lookml-dashboard#layout) dashboards  
`top` | Defines the top-to-bottom position of the element in units of [`tile_size`](/looker/docs/reference/param-lookml-dashboard#tile_size) for [`layout: static`](/looker/docs/reference/param-lookml-dashboard#layout) dashboards  
`left` | Defines the left-to-right position of the element in units of [`tile_size`](/looker/docs/reference/param-lookml-dashboard#tile_size) for [`layout: static`](/looker/docs/reference/param-lookml-dashboard#layout) dashboards  
...
The parameters described in this section correspond to the options in the [**Series** menu](/looker/docs/waterfall-options#series_menu_options) of the visualization editor for waterfall charts.

### `up_color`

Set the color of the positive value bars in the chart. The color value can take a hex string enclosed in quotes, such as "`#2ca6cd`", or a [CSS named color string](https://www.w3schools.com/cssref/css_colors.asp), such as `mediumblue`.
...
Set the color of the negative value bars in the chart. The color value can take a hex string enclosed in quotes, such as "`#2ca6cd`", or a [CSS named color string](https://www.w3schools.com/cssref/css_colors.asp), such as `mediumblue`.
...
Set the color of the total value bar in the chart. The color value can take a hex string enclosed in quotes, such as "`#2ca6cd`", or a [CSS named color string](https://www.w3schools.com/cssref/css_colors.asp), such as `mediumblue`.
...
The parameters described in this section correspond to the options in the [**Values** menu](/looker/docs/waterfall-options#values_menu_options) of the visualization editor for waterfall charts.
...
The parameters described in this section correspond to the options in the [**X** menu](/looker/docs/waterfall-options#x_menu_options) of the visualization editor for waterfall charts.
...
The parameters described in this section correspond to the options in the [**Y** menu](/looker/docs/waterfall-options#y_menu_options) of the visualization editor for waterfall charts.
