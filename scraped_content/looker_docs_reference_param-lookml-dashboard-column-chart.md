# https://cloud.google.com/looker/docs/reference/param-lookml-dashboard-column-chart

Depth: 3

This page describes the options for creating a LookML dashboard element of `type: looker_column` with LookML dashboard parameters in a [`dashboard.lkml` file](/looker/docs/other-project-files#dashboard_files).

For information about building a column chart through the Looker UI, see the [Column chart options](/looker/docs/column-options) documentation page.
...
Most of the parameters described in this section correspond to the options in the [**Plot** section](/looker/docs/column-options#plot_menu_options) of the visualization editor for column charts.
...
![](/static/looker/docs/images/show_dropoff.png)
...
The parameters described in this section correspond to the options in the [**Series** section](/looker/docs/column-options#series_menu_options) of the visualization editor for column charts.
...
The parameters described in this section correspond to the options in the [**Values** section](/looker/docs/column-options#values_menu_options) of the visualization editor for column charts.
...
The parameters described in this section correspond to the options in the [**X** section](/looker/docs/column-options#x_menu_options) of the visualization editor for column charts.
...
> **Under construction:** We are working on updating this section of the page. Meanwhile, you can check out the [Column chart options](/looker/docs/column-options#y_menu_options) documentation page to view equivalent visualization menu options for the y-axis.

The parameters described in this section correspond to the options in the [**Y** section](/looker/docs/column-options#y_menu_options) of the visualization editor for column charts.
