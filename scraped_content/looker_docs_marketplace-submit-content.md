# https://cloud.google.com/looker/docs/marketplace-submit-content

Depth: 3

This page describes how to submit content to the Looker Marketplace. For more information on creating content for submission, see the [Developing for the Looker Marketplace](/looker/docs/marketplace-develop) page.
...
To submit content to the Looker Marketplace:
  ...
  1. Review the [Looker Marketplace Security Guidelines](https://www.google.com/url?q=http://cloud.google.com/looker/trust-center/marketplace-developer-guidelines&sa=D&source=docs&ust=1649880688786086&usg=AOvVaw0RYrc62qcuh18U7jQQUejm).
  2. Fill out the [Looker Marketplace & Action Hub Submission Form](https://docs.google.com/forms/d/e/1FAIpQLSe-ERN2X9_5E9g06eYjiq4ea4s7tgrc_yjN0ZQDxfY_Y2JT2A/viewform). Make sure you have prepared:
...
> For actions, [submit a pull request](https://github.com/looker-open-source/actions/blob/master/docs/adding_actions.md) to Looker's action repository rather than creating a new repository.
...
If you need to make updates to your content, fill out the [Looker Marketplace & Action Hub Submission Form](https://docs.google.com/forms/d/e/1FAIpQLSe-ERN2X9_5E9g06eYjiq4ea4s7tgrc_yjN0ZQDxfY_Y2JT2A/viewform). Under "Type of Submission", select "Update".
