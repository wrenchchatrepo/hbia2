# https://cloud.google.com/looker/docs/best-practices/how-to-use-the-google-drive-integration
...
This page walks admins through enabling the Google Drive action. It also describes how any user who has the appropriate [permissions](/looker/docs/admin-panel-users-roles#permissions_list) can send or schedule data deliveries to a Google Drive folder. 
