# https://cloud.google.com/looker/docs/reference/param-lookml-dashboard-table-chart-legacy

Depth: 3

This page demonstrates how to add and customize a LookML dashboard element of `type: table` with LookML dashboard parameters in a [`dashboard.lkml` file](/looker/docs/other-project-files#dashboard_files).

For information about building a table (legacy) chart through the Looker UI, see the [Table (legacy) chart options](/looker/docs/legacy-table-options) documentation page.
...
The following parameters correspond to the options in the [**Plot** section](/looker/docs/legacy-table-options#plot_menu_options) of the visualization editor for table (legacy) charts.
...
The following parameters correspond to the options in the [**Series** section](/looker/docs/legacy-table-options#series_menu_options) of the visualization editor for table (legacy) charts.
...
The following parameters correspond to the options in the [**Formatting** section](/looker/docs/legacy-table-options#formatting_menu_options) of the visualization editor for table (legacy) charts.
