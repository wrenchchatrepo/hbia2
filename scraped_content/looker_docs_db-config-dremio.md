# https://cloud.google.com/looker/docs/db-config-dremio
...
Dremio supports the following features as of Looker 25.2:
...
Dremio 11+ supports the following features as of Looker 25.2:
