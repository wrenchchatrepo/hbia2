# https://cloud.google.com/looker/docs/admin-panel-users-custom-welcome-email

Depth: 3

**Note:** [Looker (Google Cloud core)](/looker/docs/looker-core-overview) instances do not include this page.
...
For a list of HTML and CSS that Looker supports, see the [HTML sanitization](/looker/docs/html-sanitization) documentation page.
