# https://cloud.google.com/looker/docs/reference/param-lookml-dashboard-area-chart

Depth: 3

This page demonstrates how to add and customize a LookML dashboard element of `type: looker_area` with LookML dashboard parameters in a [`dashboard.lkml` file](/looker/docs/other-project-files#dashboard_files).

For information about building an area chart through the Looker UI, see the [Area chart options](/looker/docs/area-options) documentation page.
...
Most of the parameters described in this section correspond to the options in the [**Plot** section](/looker/docs/area-options#plot_menu_options) of the visualization editor for area charts.
...
The `interpolation` parameter specifies the type of interpolation line to display.
  ...
  * [`monotone`](http://en.wikipedia.org/wiki/Monotone_cubic_interpolation): Displays smooth curves between points.
...
The parameters described in this section correspond to the options in the [**Series** section](/looker/docs/area-options#series_menu_options) of the visualization editor for area charts.
...
The parameters described in this section correspond to the options in the [**Values** section](/looker/docs/area-options#values_menu_options) of the visualization editor for area charts.
...
The parameters described in this section correspond to the options in the [**X** section](/looker/docs/area-options#x_menu_options) of the visualization editor for area charts.
...
> **Under construction:** We are working on updating this section of the page. Meanwhile, you can check out the [Area chart options](/looker/docs/area-options#y_menu_options) documentation page to view equivalent visualization menu options for the y-axis.

The parameters described in this section correspond to the options in the [**Y** section](/looker/docs/area-options#y_menu_options) of the visualization editor for area charts.
