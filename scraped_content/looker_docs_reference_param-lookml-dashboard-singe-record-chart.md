# https://cloud.google.com/looker/docs/reference/param-lookml-dashboard-singe-record-chart

Depth: 3

> **Under Construction:** We're working on adding more to this page. In the meantime, check out the [Single record chart options](/looker/docs/single-record-options) documentation page to view information about creating and editing single value visualizations using the visualization option menu.

The parameters described on this page are for use with LookML dashboard elements of `type: looker_single_record` in a [`dashboard.lkml` file](/looker/docs/other-project-files#dashboard_files).

For information about building a single record chart through the Looker UI, see the [Single record chart options](/looker/docs/single-record-options) documentation page.
...
This section describes the LookML equivalents of the options in the [**Edit** menu](/looker/docs/single-record-options#edit_menu_options) for single record charts.
