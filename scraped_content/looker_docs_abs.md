# https://cloud.google.com/looker/docs/abs

Depth: 3

The `abs` function can be used in [custom filters](/looker/docs/filtering-and-limiting#custom-filters) and [table calculations](/looker/docs/table-calculations) to get the absolute value of an expression.
