# https://cloud.google.com/looker/docs/mobile-app-navigating-to-content

Depth: 3

If mobile application access is [enabled](/looker/docs/mobile-app-enablement) for your instance and you have [installed](/looker/docs/mobile-app-installation) the app on your Android or iOS device, you can [sign in to your Looker account](/looker/docs/mobile-app-sign-in) and navigate to content in the app.
...
When you [sign in](/looker/docs/mobile-app-sign-in) to the Looker mobile app, the app displays the **Recently Viewed** screen. You can use the following options in the app's bottom navigation menu to navigate to the content that you want:
  ...
  * **Favorites** : Lists the Looks and dashboards that you've marked as favorites in the Looker mobile app or [in the Looker web app](/looker/docs/finding-content#favorites).
  * **Boards** : Lists the [boards](/looker/docs/presenting-content) that you have followed by [adding those boards to your list](/looker/docs/presenting-content#adding_a_board_to_your_list) in the Looker web app.
  * **More** : Displays the options to view all folders, view information about your Looker account, view privacy and legal information, report a problem, and [sign out of the app](/looker/docs/mobile-app-sign-in#signing_out_of_the_app). The folders you see in the Looker mobile app are the same as the folders you can access [in the Looker web app](/looker/docs/organizing-spaces).

You can open a Look or dashboard in the app by selecting the title or content card for the desired Look or dashboard on the **Recently Viewed** or **Favorites** screens, on a board, or in a folder. For more information on viewing Looks and dashboards in the app, see the documentation pages on [viewing Looks](/looker/docs/mobile-app-viewing-looks) and [viewing dashboards](/looker/docs/mobile-app-viewing-dashboards).
...
![](/static/looker/docs/images/mobile-recently-viewed-options-716.png)
  ...
  4. **Content cards** : Displays a card showing the title and author of the content, and a thumbnail with a preview of the colors and types of visualizations used for each Look or dashboard. You can select the content card for a Look or a dashboard to [view the Look](/looker/docs/mobile-app-viewing-looks) or [dashboard](/looker/docs/mobile-app-viewing-dashboards) in the app.

## Navigating to content from boards

In the Looker mobile app, you can access [boards](/looker/docs/presenting-content) that you or other users have [created](/looker/docs/presenting-content#creating_a_board) and that you have [added to your list of boards](/looker/docs/presenting-content#adding_a_board_to_your_list).
...
![](/static/looker/docs/images/mobile-boards-screen-716.png)
...
See the [Presenting content with boards](/looker/docs/presenting-content) documentation page for more information about viewing, creating, editing, following, and sharing boards using the Looker web app.
...
![](/static/looker/docs/images/mobile-board-example-716.png)

  1. **Board three-dot menu**: Lets you view information about the board.
  2. **Content cards** : Displays the title, the author, and a thumbnail with a preview of the colors and types of visualizations that are used in each Look or dashboard that is [pinned to the board](/looker/docs/presenting-content#adding_content_to_a_board) and that you have [access to view](/looker/docs/presenting-content#viewing_and_managing_access_to_a_board). You can select the content card for a Look or a dashboard to [view the Look](/looker/docs/mobile-app-viewing-looks) or [dashboard](/looker/docs/mobile-app-viewing-dashboards) in the app.
...
To view information about a board that you are viewing, select the three-dot menu at the top of the screen and select **Get info**. You can also select **Get info** from the three-dot menu for a board that is listed on the **Boards** screen to view information about that board. This opens the **Board Info** pop-up, which displays the following information about the board:
  ...
  2. **Description** : Displays the description that has been [added to the board](/looker/docs/presenting-content#adding_descriptions_to_a_board). This field appears only if the board contains a description.
...
You can use the Looker mobile app to browse content in [folders](/looker/docs/organizing-spaces).

### Navigating to a folder

To see all folders that you have [access to view](/looker/docs/organizing-spaces#viewing_and_managing_access_for_a_space):
  ...
  2. Select **All Folders** , which contains:
     ...
     * **LookML Dashboards** : Contains dashboards that developers have created using LookML. For more information, see the [Building LookML dashboards](/looker/docs/building-lookml-dashboards) documentation page.
     * **People** : Contains all personal folders for other users that you have [access to](/looker/docs/organizing-spaces#viewing_and_managing_access_for_a_folder).
...
![](/static/looker/docs/images/mobile-folder-example-716.png)
...
You can also access the three-dot menu for a Look or for a dashboard while viewing that content in the app. See the documentation pages on [viewing Looks](/looker/docs/mobile-app-viewing-looks) and on [viewing dashboards](/looker/docs/mobile-app-viewing-dashboards) for more information.
...
You can share Looks, dashboards, and boards with other users using the sharing options available on your mobile device, or with a third-party service that is [integrated with your Looker instance](/looker/docs/admin-panel-platform-actions#list_of_integrated_services), such as [Slack](https://slack.com/).
...
Select **Get info** from the three-dot menu for a Look or dashboard to view the following information:
  ...
  * **Description** : Displays the description of a [Look](/looker/docs/saving-and-editing-looks#editing_a_looks_description) or [dashboard](/looker/docs/editing-legacy-dashboards#description), if a description was added
