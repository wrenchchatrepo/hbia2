# https://cloud.google.com/looker/docs/looker-core-delete-restart

Depth: 3

You can delete or restart a Looker (Google Cloud core) instance.

**Important:** Deleting a Looker (Google Cloud core) instance that is [associated with a Looker Studio Pro subscription](/looker/docs/looker-core-lsp) immediately converts any in-use complimentary Looker Studio Pro licenses to paid licenses.
...
Replace the following:
  ...
  * INSTANCE_NAME: the [name](/looker/docs/looker-core-view-console#the_instances_page) of the Looker (Google Cloud core) instance
