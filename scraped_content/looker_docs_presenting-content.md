# https://cloud.google.com/looker/docs/presenting-content

Depth: 3

**Boards** in Looker provide a way for teams to find curated [dashboards](/looker/docs/viewing-dashboards) and [Looks](/looker/docs/saving-and-editing-looks#saving_looks_from_an_explore). Dashboards and Looks, which are stored in [folders](/looker/docs/organizing-spaces), can be added to multiple boards. Boards provide a way for users to perform the following tasks:
...
Access to boards and the content that is added to them, like Looks or dashboards, depends on a user's or group's board access, their [access to the folder in which that content is stored](/looker/docs/organizing-spaces#viewing_and_managing_access_for_a_space), and the [model that the Look or dashboard is based on](/looker/docs/admin-panel-users-roles#model_sets).
...
There are two access levels that can be assigned to a [user](/looker/docs/admin-panel-users-users) or [group](/looker/docs/admin-panel-users-groups) for a board: **View** and **Manage Access, Edit**.

With the **View** access level, a user can see that the board exists, add the board to their list, and view any board content that they have [access to view](/looker/docs/organizing-spaces#viewing_and_managing_access_for_a_folder).
...
![The Share this board icon is located to the left of the Board options menu and the Board Information icon.](/static/looker/docs/images/presenting-content-share-2308.png)
...
![](/static/looker/docs/images/presenting-content-manage-access-2312.png)
...
![](/static/looker/docs/images/presenting-content-manage-access-existing-2112.png)
...
![](/static/looker/docs/images/presenting-content-add-group-user-2320.png)
...
You can create a new board from the **Create** button or the **Boards** option in the [left navigation panel](/looker/docs/finding-content).

### Creating a board from the **Create** button

**Note:** If your permissions don't allow you to create dashboards, models, or connections, you won't see the **Create** button. To create boards, use the **Boards** option.
...
To create a board from the **Boards** option, follow these steps:
  ...
  1. Select the **Create or find a board** plus icon next to the [**Boards**](/looker/docs/finding-content#navigating_to_content_on_boards) option in the left navigation panel, and then select **Create a new board**.

![](/static/looker/docs/images/presenting-content-create-board-plus-icon-2220.png)
...
![](/static/looker/docs/images/presenting-content-add-to-list-2400.png)

To remove a board from your list, select the board's three-dot **Board options** menu and choose **Remove from my list**.

![](/static/looker/docs/images/presenting-content-remove-from-list-2308.png)

You can also remove a board from your list by selecting the three-dot menu that appears when you hover over a board in the [left navigation panel](/looker/docs/finding-content) and choosing **Remove from sidebar**.
...
![](/static/looker/docs/images/presenting-content-added-to-list-2220.png)
...
![](/static/looker/docs/images/presenting-content-board-contributors-2220.png)
...
![](/static/looker/docs/images/presenting-content-untitled-section-board-v2-2112.png)
...
![](/static/looker/docs/images/presenting-content-boards-new-section-v2-2112.png)
...
![](/static/looker/docs/images/presenting-content-six-dot-icon-2112.png)
...
![Select the Remove section and content from this board icon to delete the section.](/static/looker/docs/images/board-delete-section-2300.png)

  2. Looker displays a pop-up menu to confirm that you want to delete the section. Select **Delete** to delete the section.

> Removing a section from a board also removes any Looks, dashboards, or links that have been added to the board in that section. However, the Looks and dashboards still exist in their [folders](/looker/docs/organizing-spaces).
...
![](/static/looker/docs/images/presenting-content-drag-and-drop-select-2112.png)
...
![](/static/looker/docs/images/presenting-content-drag-to-new-section-2112.png)

  3. Drop the content into the desired section.

## Adding descriptions to a board

For boards that you have created or for which you have the **Manage Access, Edit** access level, you can add a description that will appear in the board's information panel and in the window that Looker displays when you [view all boards](/looker/docs/finding-content#viewing_all_boards). You can also add a description to each section of a board.
...
![](/static/looker/docs/images/presenting-content-information-icon-2112.png)
...
![](/static/looker/docs/images/presenting-content-description-pencil-2112.png)
...
![](/static/looker/docs/images/presenting-content-add-section-description-2308.png)
...
![](/static/looker/docs/images/presenting-content-saved-section-description-2112.png)
...
Other users will be able to see and interact with added content if they have [access to it](/looker/docs/organizing-spaces#viewing_and_managing_access_for_a_folder). Because content is stored in folders rather than on boards, adding and removing content from boards does not actually affect the underlying content.
...
You can also add a [LookML dashboard](/looker/docs/building-lookml-dashboards) to a board from the thumbnail in the **LookML dashboards** folder or from the three-dot **Dashboard actions** menu of the LookML dashboard that you are viewing.
...
![](/static/looker/docs/images/presenting-content-plus-icon-pin-2112.png)

If the section doesn't have any content, select the **Add content** tile.

![](/static/looker/docs/images/presenting-content-pin-to-empty-labs-2118.png)
...
To add a Look, user-defined dashboard, or LookML dashboard to a board from a [folder](/looker/docs/organizing-spaces):
...
![](/static/looker/docs/images/home-dashboard-three-dot-icon-2300.png)
...
To add a user-defined dashboard or a LookML dashboard to a board:
  ...
  1. Select the **Dashboard actions** [three-dot menu](/looker/docs/viewing-dashboards#anatomy_of_a_dashboard_\(beta\)), and choose **Add to a board**. This opens the **Add to Boards** window, where you can choose one or more boards to which you want to add the dashboard.
...
![](/static/looker/docs/images/dash-next-add-to-boards-2220.png)
...
![](/static/looker/docs/images/dash-next-add-to-boards-window-selections-2212.png)
...
![](/static/looker/docs/images/dash-next-add-to-boards-window-selections-expanded-2212.png)
...
If you have made any [temporary changes to the filters](/looker/docs/viewing-dashboards#temporarily_changing_filter_values_on_dashboards) on a dashboard that you are saving to one or more boards, you can choose whether the dashboard will be saved to those boards with its default filter values or with the current filter values applied.
...
![](/static/looker/docs/images/dash-next-add-to-boards-default-filter-2214.png)
...
If the section doesn't have any content, select the **Add content** tile.
  ...
  4. If you added a Looker dashboard URL with [custom filters applied](/looker/docs/viewing-dashboards#temporarily_changing_filter_values_on_dashboards), the option to **Include custom filter values in URL** will appear. When this option is enabled, the dashboard link uses the custom filter values. When this option is disabled, the link excludes any custom filter values and uses the default filter values.
...
![](/static/looker/docs/images/presenting-content-unpin-from-board-2300.png)
...
![The Share this board icon is located to the left of the Board options menu and the Board Information icon.](/static/looker/docs/images/presenting-content-share-menu-2112.png)
...
To delete a board, you must have the **Manage Access, Edit** access level. Deleting a board will not delete the Looks and dashboards that are added to the board, as they are stored in [folders](/looker/docs/organizing-spaces). To delete a board:

  1. Select the board's three-dot **Board options** menu, and choose **Delete board**.

![](/static/looker/docs/images/presenting-content-delete-board-2402.png)
