# https://cloud.google.com/looker/docs/bar-options
...
Bar chart visualizations require one of the following combinations of fields in the **Data** section:
  ...
  * Exactly one numeric dimension, defined in LookML as a dimension of [`type: number`](/looker/docs/reference/param-dimension-filter-parameter-types#number), and exactly one other dimension. The numeric dimension must be ordered before the other dimension in the **Data** section.
...
![](/static/looker/docs/images/bar-menu-2106.png)
...
When used with [dashboards](/looker/docs/viewing-dashboards), grid layout [becomes responsive](/looker/docs/editing-user-defined-dashboards#tile_size_and_grid_layout) to the dashboard tile size and shape, if **Number of Charts per Row** is not set. Additionally, when a bar chart that uses a **By Pivot** grid layout is added to a dashboard, and the smaller charts share the same x-axis, only the charts on the bottom of the visualization will show the axis values. This is done to aid in comparison across charts.
...
![](/static/looker/docs/images/explore-vis-top-bottom-axes-2106.png)
...
![](/static/looker/docs/images/explore-vis-y-bar-configure-axes-2106.png)
...
![](/static/looker/docs/images/reference-line-bar-2106.png)
...
![](/static/looker/docs/images/trendline-bar-2106.png)
