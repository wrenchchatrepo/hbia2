# https://cloud.google.com/looker/docs/reference/param-lookml-dashboard-line-chart

Depth: 3

This page demonstrates how to add and customize a LookML dashboard element of `type: looker_line` with LookML dashboard parameters in a [`dashboard.lkml` file](/looker/docs/other-project-files#dashboard_files).

For information about building a line chart through the Looker UI, see the [Line chart options](/looker/docs/line-options) documentation page.
...
Most of the parameters described in this section correspond to the options in the [**Plot** section](/looker/docs/line-options#plot_menu_options) of the visualization editor for line charts.
...
The parameters described in this section correspond to the options in the [**Series** section](/looker/docs/line-options#series_menu_options) of the visualization editor for line charts.
...
The parameters described in this section correspond to the options in the [**Values** section](/looker/docs/line-options#values_menu_options) of the visualization editor for line charts.
...
The parameters described in this section correspond to the options in the [**X** section](/looker/docs/line-options#x_menu_options) of the visualization editor for line charts.
...
> **Under construction:** We are working on updating this section of the page. Meanwhile, you can check out the [Line chart options](/looker/docs/line-options#y_menu_options) documentation page to view equivalent visualization menu options for the y-axis.

The parameters described in this section correspond to the options in the [**Y** section](/looker/docs/line-options#y_menu_options) of the visualization editor for line charts.
