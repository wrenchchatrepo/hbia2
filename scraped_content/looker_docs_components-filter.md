# https://cloud.google.com/looker/docs/components-filter
...
[Looker components](/looker/docs/components-overview) are React-based, prebuilt pieces of Looker's application. Application developers can use components in data applications and extensions that are built on top of Looker.
