# https://cloud.google.com/looker/docs/reference/param-lookml-dashboard-donut-multiples-chart

Depth: 3

This page demonstrates how to add and customize a LookML dashboard element of `type: looker_donut_multiples` with LookML dashboard parameters in a [`dashboard.lkml` file](/looker/docs/other-project-files#dashboard_files).

For information about building a donut multiples chart through the Looker UI, see the [Donut multiples chart options](/looker/docs/donut-multiples-options) documentation page.
...
Most of the parameters described in this section correspond to the options in the [**Plot** section](/looker/docs/donut-multiples-options#plot_menu_options) of the visualization editor for donut multiples charts.
...
The parameters described in this section correspond to the options in the [**Series** section](/looker/docs/donut-multiples-options#series_menu_options) of the visualization editor for donut multiples charts.
