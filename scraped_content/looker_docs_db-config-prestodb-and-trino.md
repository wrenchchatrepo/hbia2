# https://cloud.google.com/looker/docs/db-config-prestodb-and-trino

Depth: 3

This pages discusses how to connect Looker to [PrestoDB](http://prestodb.io/) or [Trino](https://trino.io/).  
...
**Note:** To set up a [Starburst](https://starburst.io/) connection, select **Trino**.

> [PrestoSQL has been rebranded as Trino](https://trino.io/blog/2020/12/27/announcing-trino.html#:%7E:text=We're%20rebranding%20PrestoSQL%20as%20Trino.,under%20a%20shiny%20new%20name.). If you're using a Trino version earlier than 352, select **PrestoSQL** from the Looker dialect menu.
...
> This information is only sent to the database server if SSL is enabled.
  ...
  * **Additional JDBC parameters** : Any additional parameters from the [PrestoDB JDBC driver](https://prestodb.io/docs/current/installation/jdbc.html), [Trino JDBC driver](https://trino.io/docs/current/installation/jdbc.html), or [Starburst JDBC driver](https://docs.starburst.io/latest/client/jdbc.html).

  * **SSL** : Check to enable SSL connections.

  * **Verify SSL** : Ignore this field. All SSL connections will use the default Java Truststore unless directed to do otherwise with [PrestoDB JDBC parameters](https://prestodb.io/docs/current/installation/jdbc.html), the [Trino JDBC driver](https://trino.io/docs/current/installation/jdbc.html), or the [Starburst JDBC driver](https://docs.starburst.io/latest/client/jdbc.html). Enter these parameters in the **Additional JDBC parameters** field.
...
For more information about connection settings, see the [Connecting Looker to your database](/looker/docs/connecting-to-your-db#creating_a_new_database_connection) documentation page.
...
**Note:** To use OAuth with Starburst, set up your connection as a Trino connection.
...
Note the following for database-level OAuth connections:
  ...
  * [Persistent derived tables (PDTs)](/looker/docs/derived-tables#persistent_derived_table) are not supported for Trino connections with OAuth.
...
Once you sign in to Microsoft Entra ID through Looker, you can log out or reauthorize your credentials at any time through your **Account** page, as described on the [Personalizing your user account](/looker/docs/user-account#oauth) documentation page.

### Reference

For more information about configuring your Hive connector, see [PrestoDB Hive Connector](https://prestodb.io/docs/current/connector/hive.html), [Trino Hive Connector](https://trino.io/docs/current/connector/hive.html), or [Starburst Hive Connector](https://docs.starburst.io/latest/connector/hive.html).

## Feature support

For Looker to support some features, your database dialect must also support them.

PrestoDB supports the following features as of Looker 25.2:
...
Trino supports the following features as of Looker 25.2:
