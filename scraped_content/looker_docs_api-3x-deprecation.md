# https://cloud.google.com/looker/docs/api-3x-deprecation
...
Following our [API 4.0 GA release](/looker/docs/api-4-ga) in Looker 22.4, we announced the deprecation of our 3.1 API, in addition to our already deprecated 3.0 API.
...
Customers who are not able to successfully migrate to API 4.0 should contact [Looker Support](/looker/docs/best-practices/looker-support-details).
...
#### "Space" endpoints have been renamed. Use synonymous "Folder" endpoints instead.
  ...
  * Review [folder feature documentation](https://cloud.google.com/looker/docs/organizing-spaces).
  * Refer to the [list of folder API endpoints](https://cloud.google.com/looker/docs/reference/looker-api/latest/methods/Folder).
...
#### "Homepage" endpoints have been removed. Use expanded functionality "board" endpoints instead.
  ...
  * Review [board feature documentation](https://cloud.google.com/looker/docs/presenting-content).
  * Refer to the [list of board API endpoints](https://cloud.google.com/looker/docs/reference/looker-api/latest/methods/Board/).
...
API 4.0 has updated types for some ID fields from numbers to strings. Use our [API reference diff tool](https://cloud.google.com/looker/docs/api-explorer#comparing_api_versions) to determine which ID fields have changed between 3.1 and 4.0. Use up-to-date (23.0+) [Looker-supported language SDKs](https://cloud.google.com/looker/docs/api-sdk) to ensure your applications are type correct during and after migration. Most [community-supported language SDKs](https://cloud.google.com/looker/docs/api-sdk-support-policy#language_sdks), including Kotlin, Swift, R, C# and Go, already work with the updated types as well.
...
In addition to the guidelines listed on this documentation page, the Looker API Explorer provides a full listing of [all differences between the 3.x APIs and 4.0 API](/looker/docs/api-explorer#comparing_api_versions).

## Disabling/Enabling API 3.x via Legacy Feature Toggle

**For Looker-hosted customers using Looker 23.6, 23.8, 23.10, and 23.12** , Admins currently have the ability to disable all calls to API 3 endpoints. This will allow you to test on your instance to ensure no integrated services or applications break ahead of the August 14 deadline. To do so, you can toggle on "Deny API 3.x requests" in the [Legacy Features Admin panel](https://cloud.google.com/looker/docs/legacy-feature-schedule).
...
**Important:** With the release of Looker 23.14 in August, this toggle will change from "Deny API 3.x requests" to "Allow API 3.x requests" and will be turned OFF by default, effectively disabling API 3.x. In Looker 23.14 and 23.16, admins will be able to turn this toggle ON to temporarily re-enable API 3.x. **With the release of Looker 23.18 in October, API 3.x endpoints will be fully removed**. 
...
Our internal reporting service has more detailed information on API requests, including those used to complete Admin and LookML Development tasks. Customers with instances following the [recommended networking configuration](https://cloud.google.com/looker/docs/outbound-port-requirements) can reach out to [Looker Support](https://cloud.google.com/looker/docs/best-practices/looker-support-details) to request an export of this data.
...
Customers who are not able to successfully migrate to API 4.0 should contact [Looker Support](https://cloud.google.com/looker/docs/best-practices/looker-support-details).