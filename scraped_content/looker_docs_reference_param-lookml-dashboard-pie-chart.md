# https://cloud.google.com/looker/docs/reference/param-lookml-dashboard-pie-chart

Depth: 3

This page demonstrates how to add and customize a LookML dashboard element of `type: looker_pie` with LookML dashboard parameters in a [`dashboard.lkml` file](/looker/docs/other-project-files#dashboard_files).

For information about building a pie chart through the Looker UI, see the [Pie chart options](/looker/docs/pie-options) documentation page.
...
`label_type` | Customizes the format of the labels that mark the different sections of a pie chart  
`inner_radius` | Determines the inner radius of a pie chart, effectively turning it into a donut chart  
...
Most of the parameters described in this section correspond to the options in the [**Plot** section](/looker/docs/pie-options#plot_menu_options) of the visualization editor for pie charts.
...
The parameters described in this section correspond to the options in the [**Series** section](/looker/docs/pie-options#series_menu_options) of the visualization editor for pie charts.
