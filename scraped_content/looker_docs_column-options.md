# https://cloud.google.com/looker/docs/column-options
...
![](/static/looker/docs/images/column-menu-2106.png)
...
When used with [dashboards](/looker/docs/viewing-dashboards), grid layout [becomes responsive](/looker/docs/editing-user-defined-dashboards#tile_size_and_grid_layout) to the dashboard tile size and shape, as long as **Number of Charts per Row** is not set.
...
![](/static/looker/docs/images/column-percent-of-previous-2106.png)
...
![Column chart with Created Month on the x-axis and Products and Order counts on the left and the Total Sale Price on the right.](/static/looker/docs/images/explore-vis-y-column-example-2106.png)
...
![](/static/looker/docs/images/reference-line-column-2106.png)
...
![](/static/looker/docs/images/col-trendline-2106.png)
