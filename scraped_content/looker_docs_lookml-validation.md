# https://cloud.google.com/looker/docs/lookml-validation
...
![](/static/looker/docs/images/dev-validate-lookml-2402.png)
...
![](/static/looker/docs/images/lookml-warnings-expanded-list-720.png)
...
![](/static/looker/docs/images/no-lookml-errors-720.png)
...
![Example of a validation message with the text LookML Errors \(9\).](/static/looker/docs/images/lookml-errors-message-720.png)
...
![Example of an error that appears upon hover for a type parameter definition with no value, with error text stating that you must provide a value for type.](/static/looker/docs/images/lookml-row-error-720.png)
...
![Example of a validation message with the text LookML Warnings \(3\).](/static/looker/docs/images/lookml-warnings-message-720.png)
...
![Example of a warning with text stating that the Explore must match a view name, or that the Explore must have a from or view_name property.](/static/looker/docs/images/lookml-row-warning-712.png)
