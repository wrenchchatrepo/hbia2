# https://cloud.google.com/looker/docs/looker-and-studio-shared-terms-glossary
...
See the [Connecting to Looker Studio](/looker/docs/looker-studio-connector) documentation page to learn more about connecting Looker and Looker Studio.

## Connection, connector

Similar

**Looker term** : [Connection](/looker/docs/glossary#connection)

In the **Admin** section of Looker, you establish the database connection from which a model will retrieve data.

**Looker Studio term** : [Connector](https://support.google.com/looker-studio/answer/6318763)
...
**Looker** term: [Content access](/looker/docs/glossary#access)
...
**Looker Studio** term: [Roles, permissions](https://support.google.com/looker-studio/answer/10403868)
...
**Looker term** : [Cross-filtering dashboards](/looker/docs/cross-filtering-dashboards)
...
**Looker Studio term** : [Chart cross-filtering](https://support.google.com/looker-studio/answer/9173401)
...
**Looker term** : [Dashboard](/looker/docs/glossary#dashboard)
...
**Looker Studio term** : [Report](https://support.google.com/looker-studio/answer/6302400)
...
Although the appearance both dashboards and reports can be customized with custom themes and different types of elements, each type report component — [controls](https://support.google.com/looker-studio/topic/6371413), [charts](https://support.google.com/looker-studio/topic/7059081), or [all report components](https://support.google.com/looker-studio/answer/12253817#style) — can be uniquely stylized.

Users create report components and create dashboard tiles using different methods. [Report components are added](https://support.google.com/looker-studio/answer/6291062) to a report from the report panels. [Dashboard tiles can be created](/looker/docs/creating-user-defined-dashboards#adding_tiles_and_text_to_a_dashboard) as Explore or Looks and then later saved to a dashboard or they can be created directly in the dashboard. [LookML dashboards are created](/looker/docs/building-lookml-dashboards) by LookML developers and stored as version-controlled files.

## Dashboard filter, filter properties

Similar

**Looker term** : [Dashboard filters](/looker/docs/filters-user-defined-dashboards#understanding_dashboard_filters)
...
**Looker Studio term** : [Filter properties](https://support.google.com/looker-studio/answer/6291066)
...
**Looker term** : [Dashboard filter controls](/looker/docs/filters-user-defined-dashboards#dashboard_filter_controls)
...
**Looker Studio term** : [Filter controls](https://support.google.com/looker-studio/answer/6312144)
...
Report editors can limit the scope of a control [by grouping it with one or more charts](https://support.google.com/looker-studio/answer/7514442). Once grouped, the control only affects the charts that are in the group.
...
**Looker term** : [Data access, access level](/looker/docs/glossary#access)
...
**Looker Studio term** : [Credentials](https://support.google.com/looker-studio/answer/12269110)
...
**Looker term** : [Dimension](/looker/docs/glossary#dimension)
...
**Looker Studio term** : [Dimension](https://support.google.com/looker-studio/answer/6303401)
...
**Looker term** : [Linked filters](/looker/docs/filters-user-defined-dashboards#setting_up_linked_filters)
...
**Looker Studio term** : [Filter inheritance](https://support.google.com/looker-studio/answer/6291066#filter-inheritance)
...
**Looker term** : [Measure](/looker/docs/glossary#measure)
...
**Looker Studio term** : [Metric](https://support.google.com/looker-studio/answer/6380885)
...
**Looker term** : [Merged results](/looker/docs/glossary#merged-results)
...
**Looker Studio term** : [Blended data](https://support.google.com/looker-studio/answer/9194489)
...
Merged results in Looker and blends in Looker Studio are **different** in the following ways:
  ...
  * Merge logic: 
    ...
    * In **Looker Studio** , blends combine data directly from up to five different tables within a single data source or across data sources, using a process that is similar to SQL joins. You can choose the type of join in the blend editor in the Looker Studio UI. Metrics are treated as unaggregated dimensions in the blended table, which allows for [reaggregating data (like calculating the average of averages)](https://support.google.com/looker-studio/answer/9429470) in Looker Studio.
...
**Looker term** : [Parameter](/looker/docs/glossary#parameter)
...
In addition to these general parameters in LookML, Looker has a specific parameter called [`parameter`](/looker/docs/reference/param-field-parameter) that creates a filter-only field that can be used to filter Explores, Looks, and dashboards. This filter-only field cannot be added to a result set.

**Looker Studio term** : [Parameter](https://support.google.com/looker-studio/answer/9002005)
...
**Looker term** : [Table calculation](/looker/docs/glossary#table-calc)
...
**Looker Studio term** : [Calculated fields](https://support.google.com/looker-studio/answer/6299685)
