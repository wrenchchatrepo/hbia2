# https://cloud.google.com/looker/docs/api-sdk-support-policy
...
---|---|---|---  
[Ruby](https://github.com/looker-open-source/looker-sdk-ruby) | Looker | Hand-written | The current Ruby SDK reads the Looker API specification to dynamically construct the SDK methods.  
[Python](https://pypi.org/project/looker-sdk/) | Looker | [codegen](https://github.com/looker-open-source/sdk-codegen) | The Python SDK is used wherever Python can be used. See the [Python SDK readme](https://github.com/looker-open-source/sdk-codegen/tree/main/python#looker-sdk) for the latest information on supported Python versions.  
[TypeScript](https://www.npmjs.com/package/@looker/sdk) | Looker | [codegen](https://github.com/looker-open-source/sdk-codegen) | The TypeScript SDK is used for both [node](https://www.npmjs.com/package/@looker/sdk-node) and [browser](https://www.npmjs.com/package/@looker/sdk) applications.  
[Kotlin](https://github.com/looker-open-source/sdk-codegen/tree/main/kotlin) | Community | [codegen](https://github.com/looker-open-source/sdk-codegen) | The Kotlin SDK is used for Android mobile and Java Virtual Machine (JVM) applications.  
[Swift](https://github.com/looker-open-source/sdk-codegen/tree/main/swift/looker) | Community | [codegen](https://github.com/looker-open-source/sdk-codegen) | The Swift SDK is used for iOs and macOS applications.  
[R](https://github.com/looker-open-source/lookr) | Community | Swagger | LookR is the Looker SDK for the R programming language and works with R Studio.  
Other | Community | [codegen](https://github.com/looker-open-source/sdk-codegen) | Other language SDKs that are generated by Looker's codegen project — such as C# (Look#) and Go (GoLook) — are Community supported. Issues should be filed in the [sdk-codegen](https://github.com/looker-open-source/sdk-codegen/issues) repository.  
