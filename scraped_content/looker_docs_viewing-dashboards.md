...
![](/static/looker/docs/images/new-dashboard-example-2206.png)

To view a dashboard, you must have:

  * The [**View**](/looker/docs/organizing-spaces#folder_access_levels) access level for the folder in which the dashboard resides
  * The [`see_user_dashboards`](/looker/docs/admin-panel-users-roles#see_user_dashboards) Looker permission

Additionally, to view a specific dashboard tile, you must have [access to the model](/looker/docs/admin-panel-users-roles#model_sets) the tile is based on.

For more information on the access levels and permissions required to [view a dashboard](/looker/docs/access-control-and-permission-management#viewing_a_folder_and_lists_of_looks_and_dashboards) or [view dashboard tiles](/looker/docs/access-control-and-permission-management#viewing_data_in_looks_and_dashboards), visit the [Access control and permission management](/looker/docs/access-control-and-permission-management) documentation page.
...
![](/static/looker/docs/images/new-dash-breadcrumb-2114.png)
...
![](/static/looker/docs/images/dashboard-beta-title-favorite-2110.png)

The dashboard title and the heart-shaped favorite indicator appear at the top left of the dashboard.

The dashboard favorite indicator shows whether you have [marked the dashboard as a favorite](/looker/docs/finding-content#marking_content_as_a_favorite). If the dashboard is marked as a favorite, the heart icon is colored solid blue. You can also favorite or unfavorite directly in the dashboard by clicking on the heart.

### Add to boards icon

![The Add to boards icon, which is a plus sign within two stacked squares.](/static/looker/docs/images/dash-next-add-to-boards-2220.png)

The **Add to boards** icon appears to the right of the dashboard title and the heart-shaped favorite indicator.

Selecting the **Add to boards** icon opens the **Add to Boards** window, where you can [add the dashboard to one or more boards](/looker/docs/presenting-content#adding_with_the_add_to_boards_icon). Any boards that you have selected appear in the right-hand pane of the **Add to Boards** window.

### Dashboard filters

Dashboard filters appear in the filter bar at the top of the dashboard.

The filter bar, which contains the filters, may be [set to](/looker/docs/editing-user-defined-dashboards#default_filters_view) collapsed or expanded by default. If the filter bar is collapsed, you will see a number next to the filters icon at the top of the dashboard:

![An image of the filter bar with the text '4 filters' next to the filters icon.](/static/looker/docs/images/new-dash-filters-collapsed-2220.png)

You can click the icon to expand the filter bar and see the filters.

#### Filter controls

There are a variety of [filter controls](/looker/docs/filters-user-defined-dashboards#dashboard_\(beta\)_filter_controls) that you might see. They can be [displayed as](/looker/docs/filters-user-defined-dashboards#displaying_dashboard_\(beta\)_filters):
...
![](/static/looker/docs/images/dash-beta-last-updated-2116.png)
...
![](/static/looker/docs/images/dboards-beta-reload-icon-2114.png)
...
If [**Run on load**](/looker/docs/editing-user-defined-dashboards#run_on_load) is disabled for the dashboard, when a dashboard is opened the icon becomes a **Load** button, which you must click to load the dashboard's data.

### Filters icon

![The filters icon, which is a series of horizontal lines arranged to look like a downward pointing triangle.](/static/looker/docs/images/new-dash-hide-filters-2114.png)
...
The three-dot dashboard menu is revealed when you click the three-dot icon at the top right of the dashboard. The menu provides the following options (depending on your [permissions](/looker/docs/admin-panel-users-roles#permissions_list)):

  * Clear cache and refresh
  * [Edit dashboard](/looker/docs/editing-user-defined-dashboards)
  * [Show dashboard details](/looker/docs/viewing-dashboards#dashboard_details)
  * [Dashboard performance summary](/looker/docs/system-activity-dashboards#dashboard_diagnostics)
  * Copy dashboard
  * Get LookML
  * [Download](/looker/docs/downloading#downloading_data_from_a_dashboard)
  * [Schedule delivery](/looker/docs/scheduling-and-sending-dashboards)
  * Add to a board
  * Get embed URL
  * Get link
  * Reset filters
  * Dashboard time zone
  * [Move to trash](/looker/docs/editing-user-defined-dashboards#deleting_dashboards_\(beta\))

You must have the [**Manage Access, Edit**](/looker/docs/organizing-spaces#folder_access_levels) access level for the dashboard, or be a Looker admin, to see the options to edit the dashboard or move the dashboard to the trash. Filters must be present on the dashboard to see the **Reset filters** option.
...
This panel displays several metadata items. These include:
  ...
  * **Description** : A text description of the dashboard, if a [description has been added](/looker/docs/creating-user-defined-dashboards#adding_a_description_to_a_dashboard)
...
![](/static/looker/docs/images/dashboards-beta-tile-example-2414.png)

### Explore from here

The **Explore from here** icon explore allows you to [explore the tile's data](/looker/docs/creating-and-editing-explores).

### Alerts

If your Looker admin has given you permission, you can use the bell icon at the upper right of a tile to create or follow an [alert](/looker/docs/alerts-overview) on the tile. A numeric indicator will show how many alerts you are permitted to view on that tile.

![](/static/looker/docs/images/dash-beta-alert-indicator-2116.png)
...
Depending on the permissions that your Looker admin has given you, each tile's three-dot **Tile actions** menu provides the following options:
  ...
  * **Explore from here** , which lets you [explore the tile's data](/looker/docs/creating-and-editing-explores)
  * Download the tile's data
  * View the tile's parent Look (for [Look-linked tiles](/looker/docs/creating-user-defined-dashboards#look-linked_tiles) only)
  * Clear cache and refresh the tile to update its data

![](/static/looker/docs/images/dash-beta-tile-three-dot-menu-2500.png)

If a tile contains a [**Table**](/looker/docs/table-options) or a [**Table (Legacy)**](/looker/docs/legacy-table-options) chart, the tile menu will also show options to [**Autosize all columns**](/looker/docs/table-options#autosize_all_columns) and [**Reset all column widths**](/looker/docs/table-options#reset_all_column_widths).

> Changes made to column widths using the **Autosize all columns** or **Reset all column widths** option are not saved after you close the dashboard. To save changes to settings, enter [edit mode](/looker/docs/editing-user-defined-dashboards#entering_edit_mode_in_dashboards) on the dashboard, [click **Edit** in the tile's three-dot menu](/looker/docs/editing-user-defined-dashboards#editing_a_tiles_query_or_look), and change the settings in the edit window that appears.
...
If your Looker admin has enabled the **Full Screen Visualizations** [Labs feature](/looker/docs/admin-panel-general-labs), you will see an additional menu item in each tile's three-dot **Tile actions** menu, **View**. Selecting **View** opens a submenu that reveals options for **Expanded** or **Full Screen** :

![A dashboard tile with the View submenu revealed.](/static/looker/docs/images/view-menu-2302.png)

Selecting **Expanded** from the submenu opens an overlay on top of the dashboard with an expanded view of the tile:

![](/static/looker/docs/images/expanded-view-2302.png)
...
If your Looker admin has enabled the **Data history playback (data change over time animation) for visualization** [Labs feature](/looker/docs/admin-panel-general-labs), you will see an additional menu item in each tile's three-dot **Tile actions** menu, **Data History Playback**.
...
**Data History Playback** is available for tiles that contain data from an [Explore](/looker/docs/creating-and-editing-explores#explores_are_the_starting_point_for_exploration) that contains a [time field](/looker/docs/reference/param-dimension-filter-parameter-types#time), even if the time field is not present in the query the tile is based on. If a tile is based on an Explore that contain no time fields, **Data History Playback** is unavailable and disabled in the three-dot **Tile actions** menu. **Data History Playback** is also unavailable for merged results tiles.
...
![A data history playback window annotated with numbers 1-9](/static/looker/docs/images/data-history-playback-2220.png)
...
If your Looker admin has enabled [**User Specific Time Zones**](/looker/docs/using-time-zone-settings#user_specific_time_zones) and your dashboard time zone is set to **Each tile's timezone** , you may see a globe icon in the upper right corner of a tile. This indicates that the tile has a different time zone than the default dashboard time zone and that the tile is not in your default time zone, which is set in your [account settings](/looker/docs/user-account#profile_section). Hover over the globe icon to see the time zone that the tile is using.

![](/static/looker/docs/images/dash-next-tile-timezone-2414.png)
...
You may be able to zoom in on dashboard tiles that contain [Cartesian charts](/looker/docs/visualization-types#cartesian_charts) (column, bar, scatterplot, line, area, waterfall, or boxplot charts).
...
![](/static/looker/docs/images/zoom-selection-2220.png)
...
![](/static/looker/docs/images/zoom-result-2220.png)
...
If a tile's visualization has the [**Allow Zoom** option](/looker/docs/scatter-options#y-allow_zoom) on the **Y** menu disabled, you cannot zoom into smaller portions of the y-axis; you can zoom only into smaller portions of the x-axis. When you highlight an area to zoom, the entire y-axis will be included as shown in the following tile:

![A dashboard tile with a highlighted zoom area that covers the whole y-axis and a portion of the x-axis.](/static/looker/docs/images/zoom-y-axis-disabled-2220.png)

If a tile's visualization has the [**Allow Zoom** option](/looker/docs/scatter-options#x-allow_zoom) on the **X** menu disabled, you cannot zoom in on the visualization at all.
...
![](/static/looker/docs/images/dash-beta-hover-2302.png)
...
![](/static/looker/docs/images/dash-beta-data-point-2204.png)
...
![](/static/looker/docs/images/dash-beta-data-point-explore-2206.png)
...
Click **Explore** at the top of the overlay to navigate to an [Explore page](/looker/docs/creating-and-editing-explores) that contains this data, where you can explore the data more.

Click **Download** in the top right to [download](/looker/docs/downloading) the data in the drill overlay.
...
![](/static/looker/docs/images/dash-beta-drill-menu-718.png)
...
![](/static/looker/docs/images/dash-beta-drill-overlay-718.png)
...
![](/static/looker/docs/images/dash-beta-drill-overlay-2-2214.png)

If a LookML developer has set up [visual drilling](/looker/docs/reference/param-field-link#example:_using_link_to_customize_drill_visualizations) for the data you are drilling into, you may see a visualization instead of a data table when you choose a drill menu option. Switch between the visualization and the data table by clicking the **Visualization** and **Table** buttons at the top of the drill window:

![](/static/looker/docs/images/drilling-non-table-dash-next-2104.png)

In some instances, you must use right-click to open the drill menu:

  * When you view [single value visualizations](/looker/docs/single-value-options)
  * When you click on certain data points in [table visualizations](/looker/docs/table-options)
  * When [cross-filtering](/looker/docs/cross-filtering-dashboards#enabling_cross-filtering_for_individual_dashboards_\(beta\)) is enabled on a dashboard

### Links

If your Looker developers have added clickable [links](/looker/docs/reference/param-field-link) to your data, these links will appear in the drill menu under a **Links** heading. In [table visualizations](/looker/docs/table-options), the presence of a link is indicated by an ellipsis that follows the data in a field.

![](/static/looker/docs/images/dash-beta-drill-menu-links-718.png)
...
Your Looker developers may have added [data actions](/looker/docs/reference/param-field-action) to the dimensions or measures in your data. With data actions, you can perform tasks with other tools directly from Looker, such as sending an email or setting values in other applications. These data actions appear in the drill menu under an **Actions** heading.

![](/static/looker/docs/images/dash-beta-drill-menu-data-action-714.png)
...
Not all data actions require a pop-up form. In that case, the action is triggered as soon as a user clicks on it. See the [`action`](/looker/docs/reference/param-field-action#using_a_data_action_without_a_form) documentation page for more information.
...
> If you have temporarily changed the filter values on a dashboard that you want to [add to one or more boards](/looker/docs/presenting-content#adding_with_the_add_to_boards_icon), you can turn on the **Include custom filter values** toggle to add that dashboard with the custom filter values applied.

Looker dashboards can have one or more [filters](/looker/docs/filters-user-defined-dashboards) that affect one or more tiles. Filters appear at the top of the dashboard (if a **More** button appears at the top of your dashboard, click it to see all filters). You can format dashboard filters using a variety of [controls](/looker/docs/filters-user-defined-dashboards#dashboard_\(beta\)_filter_controls) that you can interact with in different ways.
...
![](/static/looker/docs/images/dashboard-beta-example-filter-2304.png)

To change its timeframe, click on the filter to display a drop-down menu of preset range options.

![](/static/looker/docs/images/new-dash-preset-options-2304.png)

Click **More** to see additional options.

![](/static/looker/docs/images/new-dash-more-options-2304.png)

Select the **Custom** tab to set any date range you want.

![](/static/looker/docs/images/dashboard-beta-custom-date-filter-2304.png)
...
If you change a filter value and any tiles do not update, the filter may not currently apply to those tiles. To adjust which tiles a filter applies to, you must [edit the filter](/looker/docs/filters-user-defined-dashboards#editing_dashboard_\(beta\)_filters).
...
In that case, you must select **Edit dashboard** from the three-dot dashboard menu, [edit the dashboard filter itself](/looker/docs/filters-user-defined-dashboards#editing_dashboard_\(beta\)_filters), and then save the dashboard with your edits. Everyone who has access to the dashboard will see the updated version you saved.

## Resetting filter values

To reset all filters to their default values, select **Reset filters** from the [three-dot dashboard menu](/looker/docs/viewing-dashboards#three-dot_dashboard_menu). **Reset filters** also clears any cross-filters that appear on the dashboard.

If a filter value is [required](/looker/docs/filters-user-defined-dashboards#requiring_a_filter_value), selecting **Reset filters** clears the data from any tiles linked to that filter. The data reappears when a value is selected for that filter.

Filters must be present on the dashboard for the **Reset filters** option to be visible.

## Creating cross-filters on dashboards

If cross-filtering is turned on for a dashboard, you can create cross-filters on dashboards by clicking data points within the dashboard; the rest of the dashboard will then be filtered by those data points. To learn more about cross-filtering, see the [Cross-filtering dashboards](/looker/docs/cross-filtering-dashboards) documentation page.
...
![](/static/looker/docs/images/dashboard-beta-last-updated-718.png)
...
![](/static/looker/docs/images/dashboard-beta-clear-cache-refresh-2304.png)
...
![](/static/looker/docs/images/dashboard-beta-tile-clear-cache-2404.png)

## Copying dashboards

If you have [**Manage Access, Edit** access](/looker/docs/organizing-spaces#folder_access_levels) to the folder in which a dashboard is located, you will see the **Copy dashboard** option in the dashboard's three-dot menu. Selecting this option lets you make a copy of the dashboard and place it into any other folder for which you have **Manage Access, Edit** access.

If the dashboard you are copying contains [Look-linked tiles](/looker/docs/creating-user-defined-dashboards#look-linked_tiles), the Looks those tiles are based on will also be copied and placed in the destination folder.
...
If you have the [`see_lookml`](/looker/docs/admin-panel-users-roles#see_lookml) permission, the dashboard menu displays an option to **Get LookML**.
...
![](/static/looker/docs/images/dboards-beta-dashboard-lookml-2308.png)

You can then select **Copy to Clipboard** to copy the dashboard LookML and use it to [create a LookML dashboard](/looker/docs/building-lookml-dashboards#creating_a_lookml_copy_of_a_user-defined_dashboard).
...
![](/static/looker/docs/images/dboards-beta-aggregate-tables-2308.png)

Aggregate table LookML is used to [define aggregate tables](/looker/docs/reference/param-explore-aggregate-table), which make use of Looker's [aggregate awareness](/looker/docs/aggregate_awareness) logic to optimize the number of queries made on large database tables. This can improve query and dashboard performance.

To learn more about how to use the aggregate table LookML that is generated through the **Get LookML** option, see the [`aggregate_table`](/looker/docs/reference/param-explore-aggregate-table#getting_aggregate_table_lookml_from_a_dashboard) parameter documentation page.

## Viewing the LookML for a LookML dashboard

If you have the [`see_lookml`](/looker/docs/admin-panel-users-roles#see_lookml) permission, you can go to the LookML for a LookML dashboard by selecting the **Go to LookML** option from the dashboard menu.
...
You can add dashboards to boards in several ways:
  ...
  * [Adding the dashboard to a board from a board](/looker/docs/presenting-content#adding_from_a_board)
  * [Adding the dashboard to a board from a folder](/looker/docs/presenting-content#adding_from_a_folder)
  * [Adding the dashboard to a board from a dashboard](/looker/docs/presenting-content#pinning_from_a_look_or_dashboard)
  * [Adding with the **Add to boards** icon on a dashboard](/looker/docs/presenting-content#adding_with_the_add_to_boards_icon)

## Downloading a dashboard

To learn about downloading data from your dashboard or from one of its tiles, visit the [Downloading content](/looker/docs/downloading#downloading_data_from_a_dashboard) documentation page.

## Getting an embed URL for a dashboard

To generate and copy either a [private embed URL](/looker/docs/private-embedding) or a [signed embed URL](/looker/docs/get-signed-embed-url) to embed your dashboard, select **Get embed URL** from the three-dot dashboard menu.

Once you've generated and copied an embed URL, you can paste the embed URL into a new browser window or tab to preview the embedded dashboard. You can also use the private URL to [embed the dashboard in an iframe](/looker/docs/private-embedding#embedding_a_dashboard).

## Keyboard shortcuts you can use when viewing dashboards

To see the keyboard shortcuts you can use when viewing dashboards, visit the [Keyboard shortcuts in Looker](/looker/docs/keyboard-shortcuts#shortcuts_when_viewing_dashboards) documentation page.