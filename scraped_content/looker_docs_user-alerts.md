# https://cloud.google.com/looker/docs/user-alerts

Depth: 3

The **Manage Alerts** user page shows a list of all the [alerts](/looker/docs/alerts-overview) that you own or follow, or for which you are listed as a recipient, depending on your alerts permissions:
...
**Note:** If your Looker admin has not given you [alerts permissions](/looker/docs/alerts-for-admins), you will not be able to access this page from the user menu.
