# https://cloud.google.com/looker/docs/admin-panel-database-datagroups
...
Type | The datagroup's trigger type, such as [`sql_trigger`](/looker/docs/reference/param-model-datagroup#sql_trigger) or [`interval_trigger`](/looker/docs/reference/param-model-datagroup#interval_trigger). If the datagroup has no specified trigger type, **Type** will be blank.  
