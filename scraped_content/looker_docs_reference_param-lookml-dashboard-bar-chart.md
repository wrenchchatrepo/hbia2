# https://cloud.google.com/looker/docs/reference/param-lookml-dashboard-bar-chart

Depth: 3

This page demonstrates how to add and customize a LookML dashboard element of `type: looker_bar` with LookML dashboard parameters in a [`dashboard.lkml` file](/looker/docs/other-project-files#dashboard_files).

For information about building a bar chart through the Looker UI, see the [Bar chart options](/looker/docs/bar-options) documentation page.
...
`hidden_series` | Shows a lightly shaded representation of a disabled chart series when the element loads  
...
Most of the parameters described in this section correspond to the options in the [**Plot** section](/looker/docs/bar-options#plot_menu_options) of the visualization editor for bar charts.
...
The parameters described in this section correspond to the options in the [**Series** section](/looker/docs/bar-options#series_menu_options) of the visualization editor for bar charts.
...
The parameters described in this section correspond to the options in the [**Values** section](/looker/docs/bar-options#values_menu_options) of the visualization editor for bar charts.
...
The parameters described in this section correspond to the options in the [**X** section](/looker/docs/bar-options#x_menu_options) of the visualization editor for bar charts.
...
> **Under construction:** We are working on updating this section of the page. Meanwhile, you can check out the [Bar chart options](/looker/docs/bar-options#y_menu_options) documentation page to view equivalent visualization menu options for the y-axis.

The parameters described in this section correspond to the options in the [**Y** section](/looker/docs/bar-options#y_menu_options) of the visualization editor for bar charts.
