# https://cloud.google.com/looker/docs/looker-core-custom-domain-settings

Depth: 3

You can view information about the custom domain that is mapped to your instance on the **CUSTOM DOMAIN** tab of the instance details page in the Google Cloud console. You navigate to the instance details page by clicking on the instance name from the [**Instances** page](/looker/docs/looker-core-view-console). The settings are as follows:
  ...
  * **Delete** : The **Delete** trash icon lets you [delete a custom domain](/looker/docs/looker-core-custom-domain-delete).
