# https://cloud.google.com/looker/docs/reference/param-lookml-dashboard-single-value-chart

Depth: 3

> **Under Construction:** We're working on adding more to this page. In the meantime, check out the [Single value chart options](/looker/docs/single-value-options) documentation page to view information about creating and editing single value visualizations using the visualization option menu.

The parameters described on this page are for use with LookML dashboard elements of `type: single_value` in a [`dashboard.lkml` file](/looker/docs/other-project-files#dashboard_files).

For information about building a single value chart through the Looker UI, see the [Single value chart options](/looker/docs/single-value-options) documentation page.
...
The parameters described in this section correspond to the options in the [**Style** section](/looker/docs/single-value-options#style_menu_options) of the visualization editor for single value charts.
...
Specify a title to display with the query's value. The title text can be [localized](/looker/docs/model-localization).
...
Specify the number format or date format for the value. The parameter accepts [Excel-style formatting](https://support.office.com/en-us/article/create-or-delete-a-custom-number-format-78f2a361-936b-4c03-8772-09fab54be7f4?ui=en-US&rs=en-US&ad=US). If no formatting is specified, the value will be displayed in the format of the underlying dimension or measure.

## Comparison parameters

The parameters described in this section correspond to the options in the [**Comparison** section](/looker/docs/single-value-options#comparison_menu_options) of the visualization editor for single value charts.
...
Specify the label to be displayed with the comparison field. The comparison label text can be [localized](/looker/docs/model-localization).
